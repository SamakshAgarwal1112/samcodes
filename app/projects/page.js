...
export default function Projects() {
  const projects = [
    ...
    {
      title: 'TicketChain',
      description: 'Winner at MLH Hackathon hackCBS 7.0. Built a decentralized event ticketing platform designed to tackle the issue of black market ticketing, leveraging Web3 technology for ticketing transparency.',
      tech: ['Web3', 'Blockchain', 'React', 'Smart Contracts'],
      github: 'https://github.com/SamakshAgarwal1112',
      tags: ['Web3', 'Hackathon Winner'],
    },
  ];
